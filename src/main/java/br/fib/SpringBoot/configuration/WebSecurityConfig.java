package br.fib.SpringBoot.configuration;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/").hasRole("BASIC")
                ...
                .antMatchers(HttpMethod.GET, "/autor/list").hasRole("BASIC")
                .antMatchers(HttpMethod.GET, "/autor/novo").hasRole("BASIC")
                .antMatchers(HttpMethod.POST, "/autor/gravar").hasRole("BASIC")
                .antMatchers(HttpMethod.GET, "/autor/alterar/{id}").hasRole("BASIC")
                .antMatchers(HttpMethod.GET, "/autor/excluir/{id}").hasRole("BASIC")

                .antMatchers(HttpMethod.GET, "/user/list").hasRole("ADMIN").and().formLogin()
